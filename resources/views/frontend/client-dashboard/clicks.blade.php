    ...
    <div class="container">
        ...
        <div class="dashboard__content-area">
            <div class="row">
                ...
                @include('frontend.client-dashboard.side-menu', ['page' => 'store-visits'])
                ...
                <div class="col main-content">
                    ...
                    <div class="section-title-wrap">
                        <h4 class="section-title">Store Visits</h4>
                        <p class="section-para">On this page, you'll find your visted stores.</p>
                    </div>

                    <form id="click-search-form" method="post" class="my-exitclick" novalidate="novalidate">
                        @csrf
                        <input type="hidden" name="report" value="click">
                        <input type="hidden" name="click-page" id="click-page" value="0">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#click-search-form button[type="submit"]', function(e) {
            e.preventDefault();
            dateToLess();
            searchClick();
        });
        ...
        function searchClick() {
            var formData = $('#click-search-form').serialize();
            var page = $("#click-page").val();
            var requestUrl = '{{ route('account.search_click') }}';
            if (page != 0) {
