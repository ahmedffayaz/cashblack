    ...
    <div class="container">
        ...
        <div class="dashboard__content-area">
            <div class="row">
                ...
                @include('frontend.client-dashboard.side-menu', ['page' => 'my-referrals'])
                ...
                <div class="col main-content">
                    ...
                    <div class="section-title-wrap">
                        <h4 class="section-title">My Referrals</h4>
                        <p class="section-para">On this page, you’ll find your history of referrals.</p>
                    </div>

                    <form id="referral-search-form" class="my-exitclick" novalidate="novalidate">
                        @csrf
                        <input type="hidden" name="referral-page" id="referral-page" value="0">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#referral-search-form', function(e) {
            e.preventDefault();
            dateToLess();
            searchReferral();
        });
        ...
        $(document).on('click', '.page-link', function(e) {
            ...
            $("#referral-page").val(page);
            searchReferral();
        });

        function searchReferral() {
            var formData = $('#referral-search-form').serialize();
            var page = $("#referral-page").val();
            var requestUrl = '{{ route('account.search_referrals') }}';
            if (page != 0) {
